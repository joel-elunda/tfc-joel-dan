...
import 'package:congo_translate/components/record_button.dart';
import 'package:translator/translator.dart';
import 'package:congo_translate/components/language_button.dart';
...
class _ConversationPageState extends State<ConversationPage> {
  ...
  Future<void> _initSpeechToText() async {
    ...
    if (available) {
      ...
      print("L'utilisateur a rejeté la reconnaissance vocale.");
    }
  }
